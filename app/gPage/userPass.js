...
export default class UserPass extends Component {
    ...
    fetchYear(currentUserId) {
        fetch('http://192.168.158.1:8080/apollo/ticket/fetchPassDetail.do'
            , {
                method: 'POST',
                headers: {
    ...
    render() {
        return (
            <View style={styles.container}>
                <TitleBar titleConfig="通过发票" leftButtonTitle="返回" navigator={this.props.navigator} _pressButton={this._pressButton.bind(this)} ></TitleBar>
